...
export default function WelcomePhotosPage() {
  ...
  const handleImageUpload = async (
    ...
    try {
      ...
      if (isEdit) {
        toast({
          title: 'Gambar baru dipilih',
          description: 'Akan menggantikan gambar sebelumnya saat disimpan.',
        });
      } else {
        toast({
          title: 'Berhasil',
      ...
      <div className="mb-8 flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Kelola foto banner atau slider halaman depan
          </p>
        </div>
        <Dialog
          open={dialogOpen}
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Misal: Selamat Datang di LJT"
                />
              </div>
              <div className="space-y-2">
              ...
              <div className="space-y-2">
                <Label>
                  {editingPhoto ? 'Ganti Foto (opsional)' : 'Upload Foto'}
                </Label>
                <Input
                  type="file"
                  accept="image/*"
        ...
        <Card>
          <CardContent className="text-center py-12">
            ...
            <p className="text-muted-foreground mb-4">
              Belum ada foto welcome. Upload foto untuk memulai.
            </p>
          </CardContent>
        </Card>
      )}
